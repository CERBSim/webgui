...
export class GUI extends dat.GUI {
    ...
    constructor(container, data, onchange, options_ = {}) {
        let options = {autoPlace: false, closeOnTop: true, closed: true, ...options_};
        super(options);
        ...
        if(data.draw_vol || data.draw_surf) {
            ...
            this.add(gui_status, "colormap_ncolors", 2, 32,1).onChange(this.onchange);
        }
    }
